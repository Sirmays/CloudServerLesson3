...
import com.lezenford.netty.advanced.common.message.PasswordMessage;
...
public class Client {
    ...
    public void start() {
        ...
        try {
            ...
            System.out.println("Enter the password to send messages");
            Scanner scanner = new Scanner(System.in);
            PasswordMessage passwordMessage = new PasswordMessage();
            passwordMessage.setPasswordMessage(scanner.nextLine());
            System.out.println("You entered password: " + passwordMessage);
            channel.writeAndFlush(passwordMessage);
